...
class WebsiteDeps:
    ...
    async def get_browser_page(self) -> Page:
        ...
        On Vercel where in-process Chromium can't launch on Fluid Compute the
        browser runs in a short-lived Sandbox we connect to over Playwright's
        wss protocol, everywhere else it's launched in-process.
        """
