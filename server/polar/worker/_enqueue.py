...
class JobQueueManager:
    ...
    async def flush(self, broker: dramatiq.Broker, redis: Redis) -> None:
        ...
        # On Vercel messages must go through broker.enqueue: there is no
        # resident worker reading the Redis lists written below, and the
        # queues broker applies delays natively instead of via ".DQ" queues.
